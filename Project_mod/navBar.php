...
<div id="mySidenav" class="sidenav">
  ...
  <a href="admin/login/Adminlogin.html">Admin</a>
  <a href="accounts/accountlogin.html">Accounts</a>
</div>
...
<div id="aftermySidenav" class="sidenav">
  ...
  <a href="dash.php">Teacher Dashboard</a>
  <a href="viewProfile.php">View Profile</a>
  <a href="change.php">Change Password</a>
  <a href="accountView.php">Payments</a>
  <a href="Logout.php">Log-out</a>
</div>


<!-- After login  STUDENT -->
<div id="s_aftermySidenav" class="sidenav">
  <a href="javascript:void(0)" class="closebtn" onclick="s_aftercloseNav()">&times;</a>
  <h1 align="center" style="color: whitesmoke;">ACCOUNT</h1><br>
  <a href="dashStudent.php">Student Dashboard</a>
  <a href="viewProfileStudent.php">View Profile</a>
  <a href="changeStudent.php">Change Password</a>
...
<!-- After login STUDENT -->
<script>
function s_afteropenNav() {
  document.getElementById("s_aftermySidenav").style.width = "200px";
}

function s_aftercloseNav() {
  document.getElementById("s_aftermySidenav").style.width = "0";
}
</script>
...
else if (isset($_SESSION['s_uname'])) 
{
    echo "<div class='col-10 col-s-10'><span style='font-size:20px;cursor:pointer' onclick='s_afteropenNav()'>&#9776; Account</span></div>";
}
else 
{
    echo "<p align='center'>";
