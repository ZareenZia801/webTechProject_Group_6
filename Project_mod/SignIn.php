...
<div class="col-4 col-s-4"><center>
    ...
    <form name="contactForm" action="controller/signTeacher.php" onsubmit="return validateForm()" method="POST" enctype="multipart/form-data"><br><br>
                ...
                User Name:
                    <input type="text" name="username" id="username" value="<?php if(isset($_COOKIE["username"])) { echo $_COOKIE["username"]; } ?>" placeholder="Enter your username."><br><br>


                Password:
                    <input type="password" name="password" id="password" value="<?php if(isset($_COOKIE["password"])) { echo $_COOKIE["password"]; } ?>" placeholder="Enter Password"><br><br>
