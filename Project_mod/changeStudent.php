...
<body>
  ...
  <?php 
         ...
         $student = fetchStudent($_SESSION['s_uname']);
...
<form name="Form" action="controller/changePassStudent.php" onsubmit="return validateForm()" method="POST" enctype="multipart/form-data">
